...
module ccl_stats_collector #(
    ...
    input  logic [LABEL_W-1:0] geo_ram_addr,
    ...
    // Forwarding & Compute (Stage 4 to break combinational loop)
    logic               stg4_valid;
    logic [LABEL_W-1:0] stg4_root;
    logic [31:0]        stg4_area, stg4_perim;
    ...
    logic fwd_match;
    assign fwd_match = stg4_valid && (stg3_root == stg4_root);

    logic [31:0] fwd_area, fwd_perim;
    logic [15:0] fwd_xmin, fwd_xmax, fwd_ymin, fwd_ymax;

    always_comb begin
        fwd_area  = fwd_match ? stg4_area  : area_rd;
        fwd_perim = fwd_match ? stg4_perim : perim_rd;
        fwd_xmin  = fwd_match ? stg4_xmin  : xmin_rd;
        fwd_xmax  = fwd_match ? stg4_xmax  : xmax_rd;
        fwd_ymin  = fwd_match ? stg4_ymin  : ymin_rd;
        fwd_ymax  = fwd_match ? stg4_ymax  : ymax_rd;
